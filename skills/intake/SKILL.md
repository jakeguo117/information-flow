---
name: intake
description: Weekly DigitalBrain intake.md and Yale-style discussion. Use when Jake says 「今天 Digest」「今日digest」「讨论 Digest」「今天摄入」「跑 Digest」「W38 有什么」or /intake. Appends reflection to this week's intake.md. Does not write Journal.
---
...
用户说「今天 Digest」「今日digest」「讨论 Digest」「今天摄入」「跑 Digest」「W38 有什么」「week 38」或 `/intake`：

1. 先读最近 2–3 篇 `📝 Journal/`，以及那些周记里已经挂上的 `🚀 Projects/` / Resource 小线（老项目、很小的未收线）。intake 先不上场。
2. 他如果已经说了这周画像，接住。没有就先问一句人在哪、心里在转什么。不要甩本周清单，不要出文。
3. 再打开本周 `📋 Digests/{YYYY-Wnn}/intake.md`。只挑 **一条** 和旧线 / 画像呼应的未勾选来问（Yale 式，一次一问）。对不上的略过。
4. 禁止问日 Digest vs Daily Briefing。禁止让 Jake 选模板。禁止新建 `📋 Digests/{YYYY-MM-DD}-Digest.md`。禁止新建或续写 Daily Briefing。禁止用 Linear、Gmail、Drive 顶替本周 intake。
5. 找不到本周 `intake.md`：停下来，说明 GitHub `obsidian-digitalbrain` 的 `main` 还没有周入口。不要自己编一份，不要改走旧日文件。
...
禁止整周附录。禁止把 Briefing 八条贴进对话当出文。他说「W38 有什么」也走上面的讨论，不列清单。
...
用户说「今天 Digest」「讨论 Digest」「W38 有什么」或 `/intake`：
